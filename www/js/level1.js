var board = []; //to store the three rows as lists, starting from top to bottom
board[0]=[[3,1,1,3],[3,1,3,1],[3,3,1,1],[1,1,3,3]];//border-width in px. direction: clockwise starting from top
board[1]=[[1,1,1,3],[3,3,3,1],[1,1,1,3],[3,1,3,1]];
board[2]=[[1,1,3,3],[3,1,3,1],[1,3,3,1],[3,1,1,3]];
...
var MWIN = false;
var TWIN = false;
var counter = 0; //to counter the step of the Minotaur
