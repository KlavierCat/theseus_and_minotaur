...
board[0]=[[3,1,1,3],[3,1,3,1],[3,3,1,1]];//border-width in px. direction: clockwise starting from top
board[1]=[[1,1,1,3],[3,1,1,1],[1,1,1,1]];
board[2]=[[1,3,3,3],[1,1,1,3],[1,3,1,1]];
board[3]=[[3,1,3,3],[1,1,3,1],[1,3,3,1]];
